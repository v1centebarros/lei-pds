...
public class Reservation {
    ...
    private TypeReservations classe;
    private int nPassageiros;

    public Reservation(TypeReservations classe, int nPassageiros) {
    ...
    public TypeReservations getClassName() {
        return this.classe;
    }

    public void setClasse(TypeReservations classe) {
        this.classe = classe;
    }
