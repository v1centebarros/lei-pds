...
public class Plane {
    ...
    private TypeReservations typeReservation;
    private int[] seatsT;
    ...
    public Plane(String confT, String confE) {
        ...
        if (confE != "") {
            this.typeReservation = TypeReservations.TURISTICA_EXECUTIVA;
    ...
    public TypeReservations getClassAviao() {
        return this.typeReservation;
    }

    public void setClassAviao(TypeReservations typeReservation) {
        this.typeReservation = typeReservation;
    }
    
    public void setConfAviao(TypeReservations typeReservation) {
        this.typeReservation = typeReservation;
    }
    ...
    public void makeReservation(Reservation reservation) {
        int freeInRow = 0;
        int seatToStart = 0;
        if (reservation.getClassName() == TypeReservations.TURISTICA) {
        ...
        else if (reservation.getClassName() == TypeReservations.EXECUTIVA) {
            ...
            System.err.println("ERROR: Undefined class.");
            return;
        }
    }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((typeReservation == null) ? 0 : typeReservation.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (typeReservation != other.typeReservation)
            return false;
        return true;
    }
    ...
    public String toString() {
        return "Aviao [classAviao=" + typeReservation + "]";
    }
